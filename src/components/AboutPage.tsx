        ...
        >
          ...
          <div className="relative z-10 mx-auto max-w-7xl px-6 pb-20 pt-6 md:px-8 lg:px-10">
            ...
            <section className="mt-13 relative min-h-[620px]">
              ...
              <div
                className="pointer-events-none absolute -top-20 -bottom-20 left-1/2 w-screen -translate-x-1/2 bg-gradient-to-r from-black/86 via-black/56 to-black/10"
                style={{
                  maskImage:
                    "linear-gradient(to bottom, transparent 0%, rgba(0,0,0,0.08) 8%, rgba(0,0,0,0.35) 18%, rgba(0,0,0,0.8) 32%, black 44%, black 58%, rgba(0,0,0,0.8) 68%, rgba(0,0,0,0.35) 82%, rgba(0,0,0,0.08) 92%, transparent 100%)",
                  WebkitMaskImage:
              ...
              <div className="relative z-10 flex h-full flex-col justify-center px-6 py-10 md:px-8 lg:px-10">
                <div className="max-w-[560px]">
                  ...
                  <p className="mt-6 max-w-[520px] text-lg leading-8 text-zinc-300">
                    ...
                    online presence through beautiful design, consistent
                    content, and reliable digital support.
                  </p>

                  <p className="mt-6 max-w-[520px] text-lg leading-8 text-zinc-400">
                    RJM Studio was built on the belief that great design does
                    not have to be complicated. It just needs to be intentional,
            ...
            <section className="py-16">
              <div className="text-center">
                ...
                <p className="mx-auto mt-5 max-w-3xl text-lg leading-8 text-zinc-400">
                  ...
                  want their brand to look professional, their content to
                  connect, and their digital presence to drive results.
                </p>
              </div>
