...
export default function RJMStudioServicesPage() {
  ...
  return (
    <>
      ...
      <div className="relative isolate overflow-x-clip min-h-screen bg-[#06070a] text-white">
        <GlowCursor
          color="#F4C76B"
          ...
          blendMode="screen"
        >
          {/* Full-bleed decoration stays outside the constrained content container. */}
          <div
            aria-hidden="true"
          ...
          >
            ...
            >
              <Aurora
                colorStops={["#8A5A24", "#F4C76B", "#24201B"]}
                amplitude={1}
                blend={0.65}
                speed={0.35}
              />
            ...
            <div
              ...
              style={{
                background:
                  "linear-gradient(to bottom, rgba(6,7,10,0.12), rgba(6,7,10,0.28) 55%, #06070a 100%)",
              }}
            />
          </div>

          <div className="relative z-10 mx-auto max-w-7xl px-6 pb-20 pt-6 md:px-8 lg:px-10">
            ...
            <section className="mt-13 relative min-h-[620px]">
              {/* Background image */}
              <div
                className="pointer-events-none absolute -top-20 -bottom-20 left-1/2 w-screen -translate-x-1/2"
                style={{
                  maskImage:
                    "linear-gradient(to bottom, transparent 0%, rgba(0,0,0,0.08) 8%, rgba(0,0,0,0.35) 18%, rgba(0,0,0,0.8) 32%, black 44%, black 58%, rgba(0,0,0,0.8) 68%, rgba(0,0,0,0.35) 82%, rgba(0,0,0,0.08) 92%, transparent 100%)",
                  WebkitMaskImage:
                    "linear-gradient(to bottom, transparent 0%, rgba(0,0,0,0.08) 8%, rgba(0,0,0,0.35) 18%, rgba(0,0,0,0.8) 32%, black 44%, black 58%, rgba(0,0,0,0.8) 68%, rgba(0,0,0,0.35) 82%, rgba(0,0,0,0.08) 92%, transparent 100%)",
                }}
              >
              ...
              <div
                className="pointer-events-none absolute -top-20 -bottom-20 left-1/2 w-screen -translate-x-1/2 bg-gradient-to-r from-black/82 via-black/58 to-black/18"
                style={{
                  maskImage:
                    "linear-gradient(to bottom, transparent 0%, rgba(0,0,0,0.08) 8%, rgba(0,0,0,0.35) 18%, rgba(0,0,0,0.8) 32%, black 44%, black 58%, rgba(0,0,0,0.8) 68%, rgba(0,0,0,0.35) 82%, rgba(0,0,0,0.08) 92%, transparent 100%)",
                  WebkitMaskImage:
              ...
              <div className="relative z-10 flex h-full flex-col justify-center px-4 py-10 md:px-2 lg:px-4">
                <div className="max-w-[560px]">
                  ...
                  <p className="mt-6 max-w-[500px] text-lg leading-8 text-zinc-300">
                    ...
                    digital support to help small businesses build a stronger
            ...
            <section className="py-16">
              <div className="text-center">
                ...
                <h2 className="heading-display mx-auto max-w-4xl text-4xl font-light leading-tight text-white md:text-5xl">
                  Three core services. One clear goal: helping your business
                  make an impact.
                </h2>
              </div>
            ...
            <section className="py-16">
              <div className="text-center">
                ...
                <p className="mx-auto mt-5 max-w-2xl text-base leading-8 text-zinc-400">
                  Choose from website design, social media management, and
                  ongoing digital support packages. All prices are starting
                  prices and can be tailored to your business needs.
                </p>
              </div>
              ...
              <div className="mt-12 grid gap-6 lg:grid-cols-2">
                <PremiumCard className="p-8">
                  ...
                  <p className="mt-3 text-base leading-8 text-zinc-400">
                    A range of website packages for small businesses, from
                    simple updates to full custom builds.
                  </p>
                ...
                <PremiumCard className="p-8">
                  ...
                  <p className="mt-3 text-base leading-8 text-zinc-400">
                    Monthly content and digital support packages designed to
                    keep your business visible, professional, and consistent
                    online.
                  </p>
                ...
                <div className="relative z-10 flex h-full items-center px-8 py-8 md:px-10">
                  <div className="max-w-[46%]">
                    ...
                    <p className="mt-5 max-w-sm text-base leading-8 text-zinc-300">
                      Every business is unique. Let’s chat about your goals and
                      how I can help.
                    </p>
